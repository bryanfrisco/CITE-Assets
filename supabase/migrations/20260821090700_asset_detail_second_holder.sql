-- ============================================================================
-- CITE Assets — 0050 asset_detail() names the second holder
--
-- Migration 0048 gave assets.assigned_to_secondary; this is what puts it in
-- front of somebody. Without it the detail screen would show one name for a
-- radio two people are answerable for, which is the same as not recording the
-- second name at all.
--
...
begin
  ...
  select jsonb_build_object(
    'asset', jsonb_build_object(
      ...
      'assignedToSecondaryId', a.assigned_to_secondary,
      'assignedToSecondaryName',
        (select full_name from accounts where id = a.assigned_to_secondary),
      'unitId', a.unit_id,
